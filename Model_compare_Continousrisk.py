...
# By the results of these charts, we can tell these are all profusley inaccurate. 
# This is due to the dropping of many data columns like wind, as the microbit cannot collect them, 
# but they are important for predicting FFMC and ISI.